...
public class TaskController {
    ...
    public String toDownload(@PathVariable("uid") int uid, HttpServletRequest request, HttpServletResponse response) {
        ...
        FileUtil.exportWord("word/外挂软件安全测试受理核办表.docx",
                "/Users/tjm/IdeaProjects/Intelligent_traffic33/src/main/resources/word/materials", filename, dataMap, request, response);
...
//    private DocumentConverter converter;
    ...
    public String toPdfFile(@PathVariable("task_id") String task_id) throws IOException {
        ...
        String inputPath = "/Users/tjm/IdeaProjects/Intelligent_traffic33/src/main/resources/word/materials/"+task_id+".docx";
        System.out.println(inputPath);
        String fileName = task_id+".pdf";
        word2Pdf(inputPath, fileName);
        //使用response,将pdf文件以流的方式发送的前端
        ServletOutputStream outputStream = response.getOutputStream();
        String newFilename = "/Users/tjm/IdeaProjects/Intelligent_traffic33/src/main/resources/pdf/"+task_id+".pdf";
